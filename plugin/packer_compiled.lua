...
_G.packer_plugins = {
  ...
  ["coc.nvim"] = {
    loaded = true,
    path = "/Users/kentamiyamoto/.local/share/nvim/site/pack/packer/start/coc.nvim",
  ...
  ["vim-pug"] = {
    loaded = true,
    path = "/Users/kentamiyamoto/.local/share/nvim/site/pack/packer/start/vim-pug",
    url = "https://github.com/digitaltoad/vim-pug"
  },
  ["vim-vue"] = {
    loaded = true,
    path = "/Users/kentamiyamoto/.local/share/nvim/site/pack/packer/start/vim-vue",
